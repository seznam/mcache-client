 ...
 * FILE             $Id: $
 *
 * DESCRIPTION      Bob Jenkins spooky V2 hash function: 3rd party code.
 *
 ...
 * HISTORY
 *       2012-09-16 (bukovsky)
 *                  Stolen from http://burtleburtle.net/bob/hash/spooky.html.
 */
...
uint32_t spooky(const void *buf, std::size_t size, uint32_t seed) {
    return SpookyHash::Hash32(buf, size, seed);
}
